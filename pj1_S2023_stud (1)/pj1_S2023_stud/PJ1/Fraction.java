...
public class Fraction implements FractionInterface, Comparable<Fraction>
{
	...
	public void setFraction(int num, int den) throws FractionException
	{
		// implement this method!
		// return FractionException if initial denominator is 0
        ...
        public FractionInterface simplify()
	{
		...
		// 1. Adjusts the signs of the num and den so that the num's sign 
				...
				final int findGCD = findGCD(Math.abs(num), Math.abs(den));
				num /= findGCD;
    			den /= findGCD;
	...
	public FractionInterface add(FractionInterface secondFraction)
	{
		...
		Fraction fraction2 = (Fraction) secondFraction;
        int newNum = num * fraction2.den + den * fraction2.num;
        int newDen = den * fraction2.den;
	...
	public FractionInterface divide(FractionInterface secondFraction) throws FractionException
	{
		// implement this method!
		// return FractionException if secondFraction is 0

		if(secondFraction.den==0){
			throw new FractionException();
		}
		...
		Fraction fraction2 = (Fraction) secondFraction;
		int newNum = num * fraction2.den;
		int newDen = den * fraction2.num;
		return new Fraction(newNum, newDen);
	...
	public boolean equals(Object other)
	{
		...
		if (other instanceof Fraction) {
			Fraction fraction2 = (Fraction) other;
			return this.num == fraction2.num && this.den == fraction2.den;
		}
	...
	public int compareTo(Fraction other)
	{
		...
		int crossProduct1 = this.num * other.den;
		int crossProduct2 = other.num * this.den;
